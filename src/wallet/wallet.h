...
public:
    ...
    CAmount GetCredit(const CTxOut& txout, const isminefilter& filter) const;//?通过一定的方式随机选择Out，直到被选择的Out所包含的Value之和大于等于需要转账的Value。在bitcoin中，我们把每个 Out 能够提供的 value 称为 credit
