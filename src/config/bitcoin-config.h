...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitclassic Coin developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitclassic Coin"
...
#define PACKAGE_NAME "Bitclassic Coin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitclassic Coin 0.15.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitclassic"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitclassiccoin.org/"
