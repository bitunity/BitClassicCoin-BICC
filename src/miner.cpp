...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn, bool fMineWitnessTx)
{
    ...
    addPackageTxs(nPackagesSelected, nDescendantsUpdated);//添加交易数据到block中
    ...
    pblock->nBits          = GetNextWorkRequired(pindexPrev, pblock, chainparams.GetConsensus());//计算下一个nbits，调整挖矿的难度
    pblock->nNonce         = 0;
